...
"""Configuration file for our documentation build.
...
# For some Python classes, the link to the documentation can't be properly created by Sphinx,
# and Sphinx shows a warning. nitpick_ignore makes these warnings go away. This list should be
# reviewed when a new Sphinx version comes out.
nitpick_ignore = [
    ('py:class', 'json.encoder.JSONEncoder'),
    ('py:class', 'json.decoder.JSONDecoder'),
    ('any', '_json.JSONDecoder'),
    ('any', 'StringIO')]
...
# Silence Sphinx "WARNING: nonlocal image URI found".
