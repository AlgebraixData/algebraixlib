...
class OperationsTests(unittest.TestCase):
    ...
    test_set2 = {
        "input": Multiset(Counter({
            Couplet(1, '1'): 1, Couplet(2, '2'): 2, Couplet(3, '3'): 3, Couplet(4, '4'): 4,
                      Couplet(5, '5'): 5})),
        "even_part": Set([
            Multiset(Counter({Couplet(2, '2'): 2, Couplet(4, '4'): 4})),
            Multiset(Counter({Couplet(1, '1'): 1, Couplet(3, '3'): 3,
                Couplet(5, '5'): 5}))
        ]),
        "even_part_equiv": Set([
            Couplet(Atom(True), Multiset(Counter({Couplet(2, '2'): 2, Couplet(4, '4'): 4}))),
            Couplet(Atom(False), Multiset(Counter({Couplet(1, '1'): 1, Couplet(3, '3'): 3,
                Couplet(5, '5'): 5})))
        ]),
        "input2": Multiset(Counter({
            Couplet(1, '1'): 1, Couplet(2, '2'): 2, Couplet(3, '3'): 3,
            Couplet(4, '4'): 4, Couplet(5, '5'): 5, Couplet(6, '6'): 6, Couplet(7, '7'): 7,
            Couplet(8, '8'): 8, Couplet(9, '9'): 9, Couplet(10, '10'): 10, Couplet(11, '11'): 11,
            Couplet(12, '12'): 12, Couplet(13, '13'): 13, Couplet(14, '14'): 14,
            Couplet(15, '15'): 15
        })),
        "thirds_part": Set([
            Multiset(Counter({Couplet(1, '1'): 1, Couplet(4, '4'): 4, Couplet(7, '7'): 7,
                Couplet(10, '10'): 10, Couplet(13, '13'): 13})),
            Multiset(Counter({Couplet(2, '2'): 2, Couplet(5, '5'): 5, Couplet(8, '8'): 8,
                Couplet(11, '11'): 11, Couplet(14, '14'): 14})),
            Multiset(Counter({Couplet(3, '3'): 3, Couplet(6, '6'): 6, Couplet(9, '9'): 9,
                Couplet(12, '12'): 12, Couplet(15, '15'): 15}))
        ])
    }
    ...
    def test_partition_multiset(self):
        ...
        if OperationsTests._print_examples:
            ...
            print("Thirds partition (msets) Expected:", test_set["thirds_part"])
