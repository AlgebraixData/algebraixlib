...
def core(string, begin_len=0, end_len=0):
    """Remove characters in the middle of a string by specifying the length of the beginning of the string and the
    length of the ending of the string. Ellipses are inserted in place of the core of the string that is being removed.

    :param begin_len: The length, in characters, the beginning part of the string.
    :param end_len: The length, in characters, the ending part of the string.
    """
